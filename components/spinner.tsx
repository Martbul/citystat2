...
const AnimatedView = Animated.createAnimatedComponent(
  (props: ViewProps) => <Animated.View {...props} />
);
...
const Spinner = ({ 
  ...
  const renderDots = () => {
    ...
    return (
      <AnimatedView className={`${sizeConfig[size].container} flex-row items-center justify-center space-x-1`}>
        <AnimatedView 
  ...
  const renderBars = () => {
    ...
    return (
      <AnimatedView className={`${sizeConfig[size].container} flex-row items-end justify-center space-x-1`}>
        <AnimatedView 
  ...
  const renderPulse = () => {
    ...
    return (
      <AnimatedView className={`${sizeConfig[size].container} items-center justify-center`}>
        <AnimatedView 
  ...
  return (
    <AnimatedView className={`${className}`}>
      {renderSpinner()}
    </AnimatedView>
  );
};
